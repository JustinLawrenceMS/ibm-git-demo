The purpose of this repository is to demonstrate the power of git and GitHub to a hypothetical Subversion user, thus satisfying the requirements of the IBM Fullstack Developer certification.
